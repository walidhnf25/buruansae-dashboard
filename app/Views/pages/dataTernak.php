        ...
        <?php $i = 1; ?>
          <?php foreach ($data_ternak as $ternak) : ?>
            <?php
              ...
              $waktuPrakiraanPanen = isset($ternak['waktu_prakiraan_panen']) ? strtotime($ternak['waktu_prakiraan_panen']) : null;
              $hariIni = strtotime(date('Y-m-d'));

              // Jika waktu_panen NULL dan waktu_prakiraan_panen adalah hari ini atau sudah lewat, beri warna merah
              $highlight = (is_null($ternak['waktu_panen']) && $waktuPrakiraanPanen !== null && $waktuPrakiraanPanen <= $hariIni) ? 'table-color' : '';
          ?>
          <tr class="align-middle table-light">
            ...
            <td class="<?= (is_null($ternak['waktu_panen']) && $waktuPrakiraanPanen !== null && $waktuPrakiraanPanen <= $hariIni) ? 'table-color' : ''; ?>">
              <?= $ternak['waktu_panen'] ?? ($ternak['waktu_prakiraan_panen'] ?? '-'); ?>
            </td>
            <td>
