                                ...
                                <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" min="0" class="form-control <?= ($validation->hasError('jumlah_berat_kp_kg')) ? 'is-invalid' : ''; ?>" id="jumlah_berat_kp_kg" name="jumlah_berat_kp_kg" value="<?= (old('jumlah_berat_kp_kg')) ? old('jumlah_berat_kp_kg') : $id_tanaman_obat['jumlah_berat_kp_kg']; ?>">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" min="0" class="form-control <?= ($validation->hasError('jumlah_kepala_keluarga_kp_kk')) ? 'is-invalid' : ''; ?>" id="jumlah_kepala_keluarga_kp_kk" name="jumlah_kepala_keluarga_kp_kk" value="<?= (old('jumlah_kepala_keluarga_kp_kk')) ? old('jumlah_kepala_keluarga_kp_kk') : $id_tanaman_obat['jumlah_kepala_keluarga_kp_kk']; ?>">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" min="0" class="form-control <?= ($validation->hasError('jumlah_orang_kp')) ? 'is-invalid' : ''; ?>" id="jumlah_orang_kp" name="jumlah_orang_kp" value="<?= (old('jumlah_orang_kp')) ? old('jumlah_orang_kp') : $id_tanaman_obat['jumlah_orang_kp']; ?>">
                                                <div class="invalid-feedback">
                                ...
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" min="0" class="form-control <?= ($validation->hasError('jumlah_berat_dibagikan_kg')) ? 'is-invalid' : ''; ?>" id="jumlah_berat_dibagikan_kg" name="jumlah_berat_dibagikan_kg" value="<?= (old('jumlah_berat_dibagikan_kg')) ? old('jumlah_berat_dibagikan_kg') : $id_tanaman_obat['jumlah_berat_dibagikan_kg']; ?>">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" min="0" class="form-control <?= ($validation->hasError('jumlah_kepala_keluarga_dibagikan_kk')) ? 'is-invalid' : ''; ?>" id="jumlah_kepala_keluarga_dibagikan_kk" name="jumlah_kepala_keluarga_dibagikan_kk" value="<?= (old('jumlah_kepala_keluarga_dibagikan_kk')) ? old('jumlah_kepala_keluarga_dibagikan_kk') : $id_tanaman_obat['jumlah_kepala_keluarga_dibagikan_kk']; ?>">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" min="0" class="form-control <?= ($validation->hasError('jumlah_orang_dibagikan')) ? 'is-invalid' : ''; ?>" id="jumlah_orang_dibagikan" name="jumlah_orang_dibagikan" value="<?= (old('jumlah_orang_dibagikan')) ? old('jumlah_orang_dibagikan') : $id_tanaman_obat['jumlah_orang_dibagikan']; ?>">
                                                <div class="invalid-feedback">
                                ...
                                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" min="0" class="form-control <?= ($validation->hasError('jumlah_berat_dijual_kg')) ? 'is-invalid' : ''; ?>" id="jumlah_berat_dijual_kg" name="jumlah_berat_dijual_kg" value="<?= (old('jumlah_berat_dijual_kg')) ? old('jumlah_berat_dijual_kg') : $id_tanaman_obat['jumlah_berat_dijual_kg']; ?>">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" min="0" class="form-control <?= ($validation->hasError('jumlah_kepala_keluarga_dijual_kk')) ? 'is-invalid' : ''; ?>" id="jumlah_kepala_keluarga_dijual_kk" name="jumlah_kepala_keluarga_dijual_kk" value="<?= (old('jumlah_kepala_keluarga_dijual_kk')) ? old('jumlah_kepala_keluarga_dijual_kk') : $id_tanaman_obat['jumlah_kepala_keluarga_dijual_kk']; ?>">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" min="0" class="form-control <?= ($validation->hasError('jumlah_orang_dijual')) ? 'is-invalid' : ''; ?>" id="jumlah_orang_dijual" name="jumlah_orang_dijual" value="<?= (old('jumlah_orang_dijual')) ? old('jumlah_orang_dijual') : $id_tanaman_obat['jumlah_orang_dijual']; ?>">
                                                <div class="invalid-feedback">
