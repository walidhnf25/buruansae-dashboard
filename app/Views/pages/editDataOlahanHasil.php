        ...
        <div class="col-12">
            <form action="<?= base_url(); ?>/dataOlahanHasil/update/<?= $olahan_hasil['id_data_olahan_hasil']; ?>" method="post">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select <?= ($validation->hasError('jenis_olahan')) ? 'is-invalid' : ''; ?>" name="jenis_olahan" id="jenis_olahan">
                        <option value="" class="hidden" style="display: none;">Pilih Olahan Hasil</option>
                        <?php foreach ($komoditi as $k) : ?>
                            <option value="<?= $k['nama_komoditi'] ?>" <?= old('jenis_olahan') == $k['nama_komoditi'] ? 'selected' : ''; ?>><?= $k['nama_komoditi'] ?></option>
                        <?php endforeach; ?>
                    </select>
                    <div class="invalid-feedback">
