                    ...
                    <div class="container mt-3">
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <input type="number" min="0" step="any" class="form-control <?= ($validation->hasError('jumlah_berat_kp_kg')) ? 'is-invalid' : ''; ?>" 
                                                ...
                                                value="<?= (old('jumlah_berat_kp_kg')) ? old('jumlah_berat_kp_kg') : ($id_ikan['jumlah_berat_kp_kg'] ?? 0); ?>" 
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" min="0" class="form-control <?= ($validation->hasError('jumlah_kepala_keluarga_kp_kk')) ? 'is-invalid' : ''; ?>" id="jumlah_kepala_keluarga_kp_kk" name="jumlah_kepala_keluarga_kp_kk" value="<?= (old('jumlah_kepala_keluarga_kp_kk')) ? old('jumlah_kepala_keluarga_kp_kk') : ($id_ikan['jumlah_kepala_keluarga_kp_kk'] ?? 0); ?>">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" min="0" class="form-control <?= ($validation->hasError('jumlah_orang_kp')) ? 'is-invalid' : ''; ?>" id="jumlah_orang_kp" name="jumlah_orang_kp" value="<?= (old('jumlah_orang_kp')) ? old('jumlah_orang_kp') : ($id_ikan['jumlah_orang_kp'] ?? 0); ?>">
                                                <div class="invalid-feedback">
                                                    ...
                                                    <div class="accordion-body">
                                                        <div class="row mb-3">
                                                            ...
                                                            <input type="number" min="0" step="any" class="form-control <?= ($validation->hasError('jumlah_berat_dibagikan_stunting_kg')) ? 'is-invalid' : ''; ?>" 
                                                                ...
                                                                value="<?= (old('jumlah_berat_dibagikan_stunting_kg')) ? old('jumlah_berat_dibagikan_stunting_kg') : ($id_ikan['jumlah_berat_dibagikan_stunting_kg'] ?? 0); ?>" 
                                                                oninput="calculateJumlahPanen()">
                                                                <div class="invalid-feedback">
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="number" min="0" class="form-control <?= ($validation->hasError('jumlah_kepala_keluarga_dibagikan_stunting')) ? 'is-invalid' : ''; ?>" id="jumlah_kepala_keluarga_dibagikan_stunting" name="jumlah_kepala_keluarga_dibagikan_stunting" value="<?= (old('jumlah_kepala_keluarga_dibagikan_stunting')) ? old('jumlah_kepala_keluarga_dibagikan_stunting') : ($id_ikan['jumlah_kepala_keluarga_dibagikan_stunting'] ?? 0); ?>">
                                                                <div class="invalid-feedback">
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="number" min="0" class="form-control <?= ($validation->hasError('jumlah_orang_dibagikan_stunting')) ? 'is-invalid' : ''; ?>" id="jumlah_orang_dibagikan_stunting" name="jumlah_orang_dibagikan_stunting" value="<?= (old('jumlah_orang_dibagikan_stunting')) ? old('jumlah_orang_dibagikan_stunting') : ($id_ikan['jumlah_orang_dibagikan_stunting'] ?? 0); ?>">
                                                                <div class="invalid-feedback">
                                                    ...
                                                    <div class="accordion-body">
                                                        <div class="row mb-3">
                                                            ...
                                                            <input type="number" min="0" step="any" class="form-control <?= ($validation->hasError('jumlah_berat_dibagikan_mm_kg')) ? 'is-invalid' : ''; ?>" 
                                                                ...
                                                                value="<?= (old('jumlah_berat_dibagikan_mm_kg')) ? old('jumlah_berat_dibagikan_mm_kg') : ($id_ikan['jumlah_berat_dibagikan_mm_kg'] ?? 0); ?>" 
                                                                oninput="calculateJumlahPanen()">
                                                                <div class="invalid-feedback">
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="number" min="0" class="form-control <?= ($validation->hasError('jumlah_kepala_keluarga_dibagikan_mm')) ? 'is-invalid' : ''; ?>" id="jumlah_kepala_keluarga_dibagikan_mm" name="jumlah_kepala_keluarga_dibagikan_mm" value="<?= (old('jumlah_kepala_keluarga_dibagikan_mm')) ? old('jumlah_kepala_keluarga_dibagikan_mm') : ($id_ikan['jumlah_kepala_keluarga_dibagikan_mm'] ?? 0); ?>">
                                                                <div class="invalid-feedback">
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="number" min="0" class="form-control <?= ($validation->hasError('jumlah_orang_dibagikan_mm')) ? 'is-invalid' : ''; ?>" id="jumlah_orang_dibagikan_mm" name="jumlah_orang_dibagikan_mm" value="<?= (old('jumlah_orang_dibagikan_mm')) ? old('jumlah_orang_dibagikan_mm') : ($id_ikan['jumlah_orang_dibagikan_mm'] ?? 0); ?>">
                                                                <div class="invalid-feedback">
                                                    ...
                                                    <div class="accordion-body">
                                                        <div class="row mb-3">
                                                            ...
                                                            <input type="number" min="0" step="any" class="form-control <?= ($validation->hasError('jumlah_berat_dibagikan_lansia_kg')) ? 'is-invalid' : ''; ?>" 
                                                                ...
                                                                value="<?= (old('jumlah_berat_dibagikan_lansia_kg')) ? old('jumlah_berat_dibagikan_lansia_kg') : ($id_ikan['jumlah_berat_dibagikan_lansia_kg'] ?? 0); ?>" 
                                                                oninput="calculateJumlahPanen()">
                                                                <div class="invalid-feedback">
                                                    ...
                                                    <div class="accordion-body">
                                                        <div class="row mb-3">
                                                            ...
                                                            <input type="number" min="0" step="any" class="form-control <?= ($validation->hasError('jumlah_berat_dibagikan_posyandu_kg')) ? 'is-invalid' : ''; ?>" 
                                                                ...
                                                                value="<?= (old('jumlah_berat_dibagikan_posyandu_kg')) ? old('jumlah_berat_dibagikan_posyandu_kg') : ($id_ikan['jumlah_berat_dibagikan_posyandu_kg'] ?? 0); ?>" 
                                                                oninput="calculateJumlahPanen()">
                                                                <div class="invalid-feedback">
                                    ...
                                    <div class="accordion-body">
                                        <div class="row mb-3">
                                            ...
                                            <input type="number" min="0" step="any" class="form-control <?= ($validation->hasError('jumlah_berat_dijual_kg')) ? 'is-invalid' : ''; ?>" 
                                                ...
                                                value="<?= (old('jumlah_berat_dijual_kg')) ? old('jumlah_berat_dijual_kg') : ($id_ikan['jumlah_berat_dijual_kg'] ?? 0); ?>" 
                                                oninput="calculateJumlahPanen()">
                                                <div class="invalid-feedback">
                        ...
                        <div class="row mb-3">
                            ...
                            <input type="number" min="0" step="any" class="form-control <?= ($validation->hasError('jumlah_panen_kg')) ? 'is-invalid' : ''; ?>" 
                                ...
                                value="<?= (old('jumlah_panen_kg')) ? old('jumlah_panen_kg') : ($id_ikan['jumlah_panen_kg'] ?? 0); ?>" 
                                readonly>
                                <div class="invalid-feedback">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" min="0" class="form-control <?= ($validation->hasError('jumlah_panen_ekor')) ? 'is-invalid' : ''; ?>" id="jumlah_panen_ekor" name="jumlah_panen_ekor" value="<?= isset($id_ikan['jumlah_panen_ekor']) ? $id_ikan['jumlah_panen_ekor'] : 0; ?>">
                                <div class="invalid-feedback">
